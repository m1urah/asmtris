...
The idea behind all this was to get comfortable reading and writing x64 assembly for reversing and binary exploitation. After 26 days of development, I also ended up writing a ton of x64 notes so I could share everything I've learned with you guys, which, surprisingly, turned out to be quite a lot.
...
1. **Classic**. You can choose which level to start from. To advance to the next level, you need to clear a set number of lines (formula = `(level x 10) + 10`). If you manage to beat level 29, you win!
...
4. **Zen / Practice**. Select a level, and play it! You can enable/disable game over. If disabled, lines are cleared instead of ending the game.

Modes can be selected either with the Up/Down arrow keys, or by pressing the corresponding number. To confirm your choice press ENTER.
